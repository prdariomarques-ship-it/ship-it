...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_store_customers_phone'), 'store_customers', ['phone'], unique=False)
    ...
    op.create_index(op.f('ix_calendar_starts_at'), 'calendar', ['starts_at'], unique=False)
    ...
    op.create_index(op.f('ix_embeddings_contact_id'), 'embeddings', ['contact_id'], unique=False)
    op.create_table('messages',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('contact_id', sa.Integer(), nullable=False),
    sa.Column('direction', sa.Enum('INBOUND', 'OUTBOUND', name='messagedirection'), nullable=False),
    sa.Column('media_type', sa.Enum('TEXT', 'IMAGE', 'PDF', 'AUDIO', 'LOCATION', name='messagemediatype'), nullable=False),
    sa.Column('content', sa.Text(), nullable=False),
